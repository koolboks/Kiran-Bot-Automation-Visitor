...
# #     # Update the Telegram message to indicate the current step
# #     await update.edit_text("Navigating to the visa application page...")
# #
# #     # Wait for the "APPLY FOR A VISA" button to be visible
# #     await update.edit_text("Waiting for the 'APPLY FOR A VISA' button to appear...")
# #     await page.wait_for_load_state("load")
# #     await page.wait_for_selector('a[title="APPLY FOR A VISA"]', timeout=60000)
# #
# #     # Click on the "APPLY FOR A VISA" button
# #     await update.edit_text("Clicking on the 'APPLY FOR A VISA' button...")
...
# #
# #     # Select the visa type from the CSV data
# #     await update.edit_text("Selecting the visa type...")
# #     visa_type = data.get("VisaType", "")  # Assuming "VisaType" is the key in your CSV for this field
...
# #
# #     # Determine if the applicant is outside New Zealand (Yes/No)
# #     is_outside_nz = data.get("IsOutsideNZ", "")  # Assuming "IsOutsideNZ" is the key in your CSV for this field
# #
...
# #         # Select the visa type for applicants outside New Zealand from the CSV data
# #         selected_visa_type = data.get("OutsideNZVisaType", "Visitor")  # Assuming "OutsideNZVisaType" is the key in your CSV for this field
...
# #
# #
# #     # Determine if the applicant is a citizen or permanent resident of Australia or a citizen of a visa waiver country (Yes/No)
# #     is_australian_pr_or_visa_waiver = data.get("IsAustralianPRorVisaWaiver",
# #                                                "")  # Assuming "IsAustralianPRorVisaWaiver" is the key in your CSV for this field
...
# #
# #         # Determine the purpose of visit from the CSV data and select the corresponding option
# #         purpose_of_visit = data.get("PurposeOfVisit",
# #                                     "covid-19")  # Assuming "PurposeOfVisit" is the key in your CSV for this field
# #
# #         if purpose_of_visit.lower() in ["covid-19", "tourism or holiday", "event", "professional", "family",
# #                                         "private yacht or plane", "other"]:
# #
...
# #
# #
# #             # Why you wantt to visit?
# #             # Get the selected option from the CSV data
# #             selected_option = data.get("VisitOption",
# #                                        "")  # Assuming "SelectedOption" is the key in your CSV for this field
# #
# #             await page.select_option('select[name="8aa075eb-9cb3-eb11-8236-0022480fd66e_select"]',
# #                                      value=selected_option.capitalize())
# #
# #         else:
...
# #
# #
# #     # Wait for any necessary page navigation or element loading here
# #
# #
# #     # Wait for any necessary page navigation or element loading here
# #
...
# #     #     import traceback
# #     #     traceback.print_exc()
# #     #     print(f"Error on first page: {e}")
# #     #     # Handle other errors appropriately
# #
# #
# # async def handle_next_button(page, update, bot, tag='input[type="button"][name="questionsubmit"]'):
# #     while True:
# #         is_button_visible = await page.is_visible(tag)
# #         if not is_button_visible:
# #             # Button is not visible, send message to Telegram
...
# #
# #             await handle_next_button(page,update,bot) # click submit
# #             input("Wait for necessary")
# #
# #
# #
# #
...
#
#
# # Define a configuration file to store data used throughout the script
# CONFIG = {
#     "login_page": {
#         "sign_in_name_selector": "#signInName",
#         "password_selector": "#password",
#         "next_button_selector": "button#next"
#     },
#     "first_page": {
#         "apply_for_visa_selector": 'a[title="APPLY FOR A VISA"]',
#         "visa_type_selector": 'select[name="6595ea5a-e55e-ec11-8f8f-000d3ad0d7d1"]',
#         "outside_nz_selector": 'input[id="0607d49f-8f0c-ed11-b83d-00224891ea27_TRUE"]',
#         "outside_nz_visa_type_selector": 'select[name="89ee7dfa-90b3-eb11-8236-0022480fd66e_select"]',
#         "australian_pr_or_visa_waiver_selector": 'input[id="4710ca77-136b-eb11-a812-000d3acb9f99_TRUE"]',
#         "purpose_of_visit_selector": 'select[name="cec3f50f-9cb3-eb11-8236-0022480fd66e_select"]',
#         "visit_option_selector": 'select[name="8aa075eb-9cb3-eb11-8236-0022480fd66e_select"]',
#         "next_button_selector":'input[type="button"][name="questionsubmit"]'
#     }
# }
#
# def transform_data(data):
...
#             print(f"Ignoring row: {row}. Insufficient data.")
#     return transformed_data
# async def click_next_button(page, update, bot=None, mode=None):
#     """
#     Clicks the "Next" button to proceed to the next page of the application.
#     """
#     if bot_manual_setting:
#         recent_message = await bot.message.reply_text("Do you want to continue to the next page? Reply with 'Yes' or 'No'",
#                                                       reply_to_message_id=bot.message.message_id)
#
#         while True:
#             state = load_json()  # Load JSON data inside the loop to get the most recent state
...
#                 await update.edit_text("Clicking Next button.........")
#                 if mode == 'login':
#                     await page.click(CONFIG["login_page"]["next_button_selector"])
#                 else:
#                     await page.click(CONFIG["first_page"]["next_button_selector"])
#
#                 await asyncio.sleep(0.5)
#                 await page.wait_for_load_state("domcontentloaded")
#
...
# async def login_page(update, page, data, bot=None):
#     """
#     Fills out the login page with the provided data.
#     """
#     await update.edit_text("Logging in.........")
#     await page.fill(CONFIG["login_page"]["sign_in_name_selector"], data.get("signInName", ""))
#     await asyncio.sleep(1)
#     await page.fill(CONFIG["login_page"]["password_selector"], data.get("password", ""))
#     await asyncio.sleep(1)
#
#     recent_message = await click_next_button(page, update, bot=bot, mode='login')
#
#     if recent_message:
#         update = recent_message
#
# async def first_page(update, page, data):
#     """
#     Fills out the first page of the visa application with the provided data.
#     """
#     # Update the Telegram message to indicate the current step
#     await update.edit_text("Navigating to the visa application page...")
#
...
#     await update.edit_text("Waiting for the 'APPLY FOR A VISA' button to appear...")
#     await page.wait_for_load_state("load")
#     await page.wait_for_selector(CONFIG["first_page"]["apply_for_visa_selector"], timeout=60000)
#
#     # Click on the "APPLY FOR A VISA" button
#     await update.edit_text("Clicking on the 'APPLY FOR A VISA' button...")
#     await page.click(CONFIG["first_page"]["apply_for_visa_selector"])
#
#     # Wait for the dropdown to appear
#     await update.edit_text("Waiting for the dropdown to appear...")
#     await page.wait_for_load_state("load")
#     await page.wait_for_selector(CONFIG["first_page"]["visa_type_selector"])
#
#     # Select the visa type from the CSV data
#     await update.edit_text("Selecting the visa type...")
#     visa_type = data.get("VisaType", "")  # Assuming "VisaType" is the key in your CSV for this field
#     if visa_type.lower() == "temporary visa":
#         await page.select_option(CONFIG["first_page"]["visa_type_selector"], value="Temporary visa")
#     elif visa_type.lower() == "resident visa":
#         await page.select_option(CONFIG["first_page"]["visa_type_selector"], value="Resident visa")
#     else:
#         print("Invalid visa type specified in CSV.")
#
#     # Determine if the applicant is outside New Zealand (Yes/No)
...
#     if is_outside_nz.lower() == "yes":
#         await update.edit_text("Applicant is outside New Zealand. Clicking 'Yes' button...")
#         await page.click(CONFIG["first_page"]["outside_nz_selector"])
#         await update.edit_text("Selecting visa type for applicants outside New Zealand...")
#         # Select the visa type for applicants outside New Zealand from the CSV data
#         selected_visa_type = data.get("OutsideNZVisaType", "Visitor")  # Assuming "OutsideNZVisaType" is the key in your CSV for this field
#         print(selected_visa_type)
#         await page.select_option(CONFIG["first_page"]["outside_nz_visa_type_selector"], value=selected_visa_type.capitalize())
#
#     elif is_outside_nz.lower() == "no":
#         await update.edit_text("Applicant is inside New Zealand. Clicking 'No' button...")
#         await page.click('input[id="0607d49f-8f0c-ed11-b83d-00224891ea27_FALSE"]')
...
#         await update.edit_text(
#             "Applicant is a citizen or permanent resident of Australia or a citizen of a visa waiver country. Clicking 'Yes' button...")
#         await page.click(CONFIG["first_page"]["australian_pr_or_visa_waiver_selector"])
#     elif is_australian_pr_or_visa_waiver.lower() == "no":
#
#         await update.edit_text(
#             "Applicant is not a citizen or permanent resident of Australia or a citizen of a visa waiver country. Clicking 'No' button...")
...
#             await update.edit_text(f"Selecting purpose of visit: {purpose_of_visit}...")
#
#             await page.select_option(CONFIG["first_page"]["purpose_of_visit_selector"],
...
#                                        "")  # Assuming "SelectedOption" is the key in your CSV for this field
#
#             await page.select_option(CONFIG["first_page"]["visit_option_selector"],
#                                      value=selected_option.capitalize())
#
#         else:
#             print("Invalid purpose of visit specified in CSV.")
...
#     await click_next_button(page, update)
#
# async def main(update=None, bot=None):
#     try:
#         async with async_playwright() as p:
...
#             await login_page(update, page, data, bot)
#
#             # Fill out the first page of the application
#             await first_page(update, page, data)
#
